...
import { galleryImages } from '../../lib/lnt-island-cove-mahim/images'
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          <h2 style={{
            ...
            A Life That{' '}
            <span style={{ color: 'var(--color-teal)' }}>Awaits For You</span>
          </h2>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              background: 'var(--color-teal)', opacity: 0.8, border: 'none',
