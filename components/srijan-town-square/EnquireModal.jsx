...
import { popupImage } from '../../lib/srijan-town-images'
    ...
    >
      ...
      >
        ...
        <div className="hidden sm:block sm:w-[44%] shrink-0 relative min-h-[480px]" style={{ background: '#0d1117' }}>
          <Image src={popupImage} alt="Srijan Town Square" fill className="object-contain" sizes="(max-width: 768px) 0vw, 45vw" />
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5 text-white z-10">
            <p className="text-[10px] font-semibold tracking-[3px] uppercase opacity-80 mb-1" style={{ fontFamily: F_SANS, color: 'var(--color-gold)' }}>Srijan Town Square</p>
            <p style={{ fontFamily: F_JOST, fontSize: '13px', fontWeight: 500, opacity: 0.85 }}>3/3.5/4 BHK · Starting ₹2.6 Cr** Onwards</p>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          <div className="sm:hidden w-full h-56 relative shrink-0">
            <Image src={popupImage} alt="Srijan Town Square" fill className="object-cover" style={{ objectPosition: 'top' }} sizes="100vw" />
            ...
            <div className="absolute bottom-3 left-4 text-white z-10">
              <p className="text-[9px] uppercase tracking-[2px] opacity-80" style={{ fontFamily: F_SANS }}>Srijan Town Square</p>
              <p className="text-[11px] font-medium opacity-85" style={{ fontFamily: F_JOST }}>3/3.5/4 BHK · Starting ₹2.6 Cr** Onwards</p>
            </div>
          </div>
