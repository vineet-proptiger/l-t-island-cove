...
import { masterplanImages } from '../../lib/srijan-town-images'
...
const plans = [
  ...
  { label: '3.5 BHK with Terrace',        img: masterplanImages.bhk2 },
  { label: '4 BHK with Terrace',          img: masterplanImages.bhk45 },
]
