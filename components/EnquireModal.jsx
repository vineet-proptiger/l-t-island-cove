      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(to top, rgba(26,26,46,0.85) 0%, rgba(26,26,46,0.1) 60%)",
            }}
          />
          <div className="absolute bottom-0 left-0 right-0 p-5 text-white z-10">
            <p
              className="text-[10px] font-semibold tracking-[3px] uppercase opacity-80 mb-1"
              style={{ fontFamily: F_SANS, color: "var(--color-teal)" }}
            >
            ...
            >
              2/3 BHK · Starting ₹3.50 Cr** Onwards
            </p>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          ...
          <div className="sm:hidden w-full h-56 relative shrink-0">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(to top, rgba(26,26,46,0.6) 0%, transparent 60%)",
              }}
            />
            <div className="absolute bottom-3 left-4 text-white z-10">
              <p
                className="text-[9px] uppercase tracking-[2px] opacity-80"
