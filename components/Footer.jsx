...
const Footer = () => (
  <footer style={{ background: "var(--color-dark)", color: "#fff" }}>
    ...
    >
      ...
      >
        New Launch — 2/3 BHK · Price Starting ₹3.50 Cr** Onwards
      </p>
      <div
        style={{
          display: "flex",
      ...
      <p
        ...
        data-aos-delay="100"
      >
        L&T Island Cove Mahim is a landmark luxury residential development
        offering premium 2/3 BHK residences with 87% open space across 6.29
        acres of life spaces. Featuring 7 towers with 350 super-spacious
        apartments and 50+ world-class amenities including multipurpose lawns,
        luxury clubhouse, gymnasium, poolside &amp; lot more — L&T Island Cove
        Mahim is crafted for those seeking an exceptional standard of living.
      </p>
