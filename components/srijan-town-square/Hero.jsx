...
import { heroImages } from '../../lib/srijan-town-images'
            ...
            >
              {slides.map((src, idx) => (
                <div key={idx} style={{ width: `${100 / slides.length}%`, flexShrink: 0, position: 'relative' }}>
                  <Image src={src} alt={`Srijan Town Square ${idx + 1}`} fill className="object-cover"
          ...
          <div className="p-4 flex flex-col gap-3">
            ...
            <div style={{ textAlign: 'center', paddingBottom: '10px', borderBottom: '1px solid #f0f0f0' }}>
              ...
              <p style={{
                ...
                Configuration: 3/3.5/4 BHK · 87% Open Space
              </p>
              {/* ── Google Rating ── */}
            ...
            <div style={{
              ...
              {[
                { value: '6.29', label: 'Acres of Life Spaces' },
                { value: '50+', label: 'Amenities' },
                { value: '7', label: 'Towers (B+G+15/19/24)' },
                { value: '350', label: 'Super-Spacious Apts' },
              ].map((s, i) => (
                <div key={i} style={{
                  textAlign: 'center',
                  padding: '8px 6px',
            ...
            <div style={{
              ...
              {[
                'Premium 3/3.5/4 BHK Residences',
                'Price Starting @ ₹ 2.6 Cr** Onwards',
                '87% Open Space — Breathe Free',
                'Available Units: 170 Approx/-',
              ].map((item, i, arr) => (
                <div key={i}>
                  <p style={{
