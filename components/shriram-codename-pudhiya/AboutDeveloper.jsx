...
import { PROJECT_ID, PROJECT_NAME, API_ENDPOINT, SHEET_NAME, SECRET_KEY, CITY_DISPLAY } from '../../lib/shriram-config'
  ...
  <section id="developer" className="py-10 sm:py-14 bg-[var(--color-bg-muted)] border-b border-gray-100">
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="text-center mb-10" data-aos="fade-up">
        ...
        }}>Eldeco Group — Developer Profile</span>
        <h2 style={{
        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px' }}>
              Eldeco Group is a trusted and renowned real estate developer with over 40 years of excellence in delivering quality residential projects across Delhi NCR and other cities. With a legacy of timely delivery, transparent dealings, and superior construction quality, Eldeco continues to redefine comfortable living with Eldeco Terra &amp; Sol at Sector 80, Gurgaon.</p>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '22px' }}>
              {[
                ...
                { value: 'Dec\'27', label: 'Possession Date' },
              ].map((stat, i) => (
                <div key={i} style={{
