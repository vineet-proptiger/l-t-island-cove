...
const TEAL_DARK = 'var(--color-teal-dark)'
...
const ContactForm = () => {
  ...
  if (success) return (
    <div style={{ padding: '40px 0', textAlign: 'center' }}>
      <div style={{
        width: '56px', height: '56px', borderRadius: '50%', background: 'var(--color-teal-bg)',
        display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px'
      }}>
        <svg width="28" height="28" fill="none" stroke={TEAL_DARK} strokeWidth="2.5" viewBox="0 0 24 24">
  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-4">
      <div>
        ...
        }}>Full Name <span style={{ color: TEAL }}>*</span></label>
      ...
      <div>
        <label style={{
          display: 'block', fontSize: '11px', fontWeight: '700', color: '#6b7280',
          fontFamily: F_JOST, letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '5px'
        }}>Mobile Number <span style={{ color: TEAL }}>*</span></label>
      ...
      <label style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', cursor: 'pointer' }}>
        <input type="checkbox" required defaultChecked style={{ accentColor: TEAL, marginTop: '2px', flexShrink: 0 }} />
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch max-w-6xl mx-auto">
        ...
        <div style={{
          ...
          boxShadow: '0 4px 24px rgba(74,140,152,0.1)',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px', marginBottom: '22px' }}>
              {[
                ...
                <div key={i} style={{
                  ...
                  <p style={{ fontSize: '22px', fontWeight: '800', color: TEAL_DARK, fontFamily: F_JOST, margin: 0 }}>{stat.value}</p>
