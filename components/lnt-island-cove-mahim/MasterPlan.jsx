...
import { masterplanImages } from '../../lib/lnt-island-cove-mahim/images'
...
const plans = [
  ...
  // { label: '3 BHK',        img: masterplanImages.bhk2 },
  { label: '3 BHK + 3T',          img: masterplanImages.bhk45 },
]
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          <h2 style={{
            ...
            Floor Plans &amp;{' '}
            <span style={{ color: 'var(--color-teal)' }}>Layout</span>
          </h2>
          ...
          <div className="w-full lg:w-[32%]" data-aos="fade-right">
            <div style={{
              ...
              {plans.map((plan, idx) => (
                <button key={idx} onClick={() => setActivePlan(idx)}
                  style={{
                    ...
                    padding: '15px 20px',
                    background: activePlan === idx ? 'var(--color-teal-bg)' : '#fff',
                    border: 'none',
                    borderLeft: activePlan === idx ? '3px solid var(--color-teal)' : '3px solid transparent',
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    ...
                    <span style={{
                      ...
                      background: activePlan === idx ? 'var(--color-teal)' : '#f3f4f6',
                    ...
                    <span style={{
                      ...
                      color: activePlan === idx ? 'var(--color-teal)' : '#374151',
                      transition: 'color 0.2s',
                    }}>{plan.label}</span>
                  </div>
                  {/* Arrow */}
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                    stroke={activePlan === idx ? 'var(--color-teal)' : '#d1d5db'}
              ...
              <div style={{
                ...
                background: 'var(--color-teal-bg)', borderRadius: '10px',
                border: '1px dashed var(--color-teal-light)',
              }}>
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none"
                    stroke="var(--color-teal)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
