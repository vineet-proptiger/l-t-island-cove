          ...
          >
            ...
            <div className="mb-10" data-aos="fade-up">
              ...
              <div style={{ paddingLeft: "44px" }}>
                ...
                >
                  This data is collected via form submissions, cookies, pixels,
                  and other tracking technologies for analytics,
            ...
            <div className="mb-10" data-aos="fade-up">
              ...
              >
                By continuing to use our site, you consent to the use of these
                technologies. You can manage or disable cookies via your browser
                settings, but this may impact website functionality.
              </p>
            </div>
            ...
            <div className="mb-10" data-aos="fade-up">
              ...
              <div style={{ paddingLeft: "44px" }}>
                ...
                >
                  ...
                  Google, to better understand user behavior and improve site
                  experience. Google Analytics uses cookies to collect anonymous
                  traffic data, which may be shared with Google for analysis
                  purposes.
                </p>
                <p
                  className="mb-4"
                ...
                >
                  We also use Google Ads Remarketing, allowing us to display
                  targeted ads across the internet to users who have previously
                  visited our site. Google and other third-party vendors may use
                  cookies and identifiers (e.g., GCLID) to serve ads based on
                  your past visits to this site.
                </p>
            ...
            <div className="mb-10" data-aos="fade-up">
              ...
              >
                We do not sell or share your personal data with unaffiliated
                third parties. However, anonymized or encrypted data may be used
                with our trusted marketing and analytics partners (e.g., Google,
                Meta) solely for tracking and optimization purposes.
              </p>
            </div>
