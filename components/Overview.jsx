...
const PREVIEW_TEXT = `Marvela at L&T Island Cove is the luxurious and first gated community of Mahim. The newly launched tower offers 2 BHK and 3 BHK apartments with private balconies. These residences overlook the pristine Arabian Sea and the sea link. The aesthetically pleasing homes are crafted with precision and contemporary features.`;

const MORE_TEXT = ` The spacious layout of apartments provides palatial space and unobstructed views. The recreational facilities are specially designed to fulfill your various needs. Indulge in amenities like a spa, gymnasium, reflexology track, swimming pool, multipurpose hall, yoga zone, cricket pitch, kids’ play area, walking path, library, and more.`;
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative" }}>
        ...
        >
          Full Name <span style={{ color: "var(--color-teal)" }}>*</span>
        </label>
        <input
          name="fullname"
          required
          ...
          style={{
            ...inputStyle,
            borderColor:
              focused === "fullname" ? "var(--color-teal)" : "#e5e7eb",
            boxShadow:
              focused === "fullname"
                ? "0 0 0 3px var(--color-shadow-inner)"
                : "none",
          }}
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          style={{
            ...inputStyle,
            borderColor: focused === "email" ? "var(--color-teal)" : "#e5e7eb",
            boxShadow:
              focused === "email"
                ? "0 0 0 3px var(--color-shadow-inner)"
                : "none",
      ...
      <div>
        ...
        <input
          ...
          style={{
            ...inputStyle,
            borderColor: focused === "phone" ? "var(--color-teal)" : "#e5e7eb",
            boxShadow:
              focused === "phone"
                ? "0 0 0 3px var(--color-shadow-inner)"
                : "none",
      ...
      >
        ...
        >
          I authorize the developer &amp; its representatives to contact me via
    ...
    >
      <div className="container mx-auto px-4 md:px-8">
        ...
        >
          ...
          >
            L&T Island Cove Mahim New Launch
          </span>
          <h2
            style={{
              fontFamily: F_JOST,
          ...
          >
            Project <span style={{ color: "var(--color-teal)" }}>Overview</span>
          </h2>
          <div
            style={{
              display: "flex",
