    ...
    <form onSubmit={submit} className="flex flex-col gap-4">
      <div>
        ...
        <input
          ...
          style={{ fontFamily: F_SANS, width: "100%" }}
        />
      </div>
      ...
      <div>
        ...
        >
          Mobile Number <span style={{ color: GOLD }}>*</span>
        </label>
        <input
          name="phone"
          required
...
const AboutDeveloper = ({ setIsOpen }) => (
  <section
    id="developer"
    className="py-10 sm:py-14 bg-[var(--color-bg-muted)] border-b border-gray-100"
  >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-stretch max-w-6xl mx-auto">
        ...
        >
          ...
          >
            ...
            >
              Renowned for shaping some of India&apos;s most iconic
              developments, the developer behind L&T Island Cove Mahim stands as
              a symbol of excellence, innovation, and trust. With a legacy of
              delivering landmark residences, the brand continues to redefine
              luxury living through design, craftsmanship, and an unwavering
