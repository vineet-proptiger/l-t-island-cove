    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ flex:'0 0 65%', position:'relative', overflow:'hidden' }}>
          ...
          {/* Top nav */}
          <nav className="absolute top-0 left-0 right-0 z-10 flex items-center justify-between p-3 sm:p-6 lg:p-10"
          ...
          <div className="w-full lg:w-[280px]" style={{
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'4px' }}>
              {[
                ...
                'Modern High-Rise Residences',
                '70% Open Green Spaces',
                'Spread across 11.3 acres',
              ].map((line, i) => (
                <p key={i} style={{ fontFamily:F_SANS, fontSize:'13px', lineHeight:1.6, color:'rgba(255,255,255,0.65)', fontWeight:400, margin:0, textAlign:'center' }}>
                  {line}
                </p>
              ))}
            </div>
          ...
          <div className="w-full lg:w-[320px]" style={{
            ...
            {[
              ...
              <div key={i} style={{
                ...
                <p style={{ fontFamily:F_SANS, fontSize:'9px', fontWeight:700, letterSpacing:'0.13em', textTransform:'uppercase', color:'var(--color-text-mid, #6D6E70)', lineHeight:1.35, whiteSpace:'pre-line' }}>{s.lbl}</p>
              </div>
            ))}
          </div>
          ...
          <div className="w-full lg:w-[260px]" style={{
            ...
            <div style={{ textAlign:'center' }}>
              <p style={{ fontFamily:F_SANS, fontSize:'14.5px', fontWeight:600, color:'rgba(255,255,255,0.4)', letterSpacing:'0.06em', marginBottom:'2px' }}>
                2 & 3 BHK Affordable Flats Starts
              </p>
              <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:'8px', marginBottom:'4px' }}>
                <p style={{ fontFamily:F_SANS, fontSize:'16px', fontWeight:600, color:'rgba(255,255,255,0.35)', textDecoration:'line-through', lineHeight:1, margin:0 }}>
                  ₹70 Lakhs*
                </p>
              </div>
              <p className="blink-price" style={{ fontFamily:F_JOST, fontSize:'32px', fontWeight:600, color:'var(--color-teal)', lineHeight:1 }}>
                ₹65 Lakhs*
              </p>
