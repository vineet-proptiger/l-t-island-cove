...
import { amenityImages } from '../../lib/lnt-island-cove-mahim/images'
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          <h2 style={{
            ...
            Lifestyle &amp;{' '}
            <span style={{ color: 'var(--color-teal)' }}>Wellness Amenities</span>
          </h2>
          ...
          {amenityImages.map((item, idx) => (
            ...
            >
              ...
              <div style={{
                ...
                background: 'var(--color-teal)', opacity: 0.85,
      ...
      {lightbox !== null && (
        ...
        >
          <button onClick={() => setLightbox(null)} style={{
            ...
            background: 'var(--color-teal)', opacity: 0.85, border: 'none',
